...
public class GeofenceBroadcastReceiver extends BroadcastReceiver {
    ...
    private void fireNotification(Context context, String storeName, int itemCount) {
        ...
        PendingIntent pi = PendingIntent.getActivity(context, 2001, intent,
                PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);

        NotificationCompat.Builder builder =
                new NotificationCompat.Builder(context, "geofence_alerts")
